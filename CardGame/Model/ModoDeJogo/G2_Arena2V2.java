package Model.ModoDeJogo;
import java.io.FileWriter;
import java.io.IOException;
import java.util.Random;

import Controller.F_Lobby;
import Model.Cards.C2_CartaShiny;
import Model.Cards.C_Carta;
import Model.Cards.Deck.D_Deck;
import Model.ENUMs.Skill.Magias.K_Feitico;
import Model.Pass.PasseComum;
import Model.Pass.PassePremium;
...
//Metodo pega o indice do vetor mao e retorna ele para escolher quais cartas vao retornar ( cartas vao dar REROLL)
    ...
    public void logVitoria(A_Usuario vencedor) {
        try {
            FileWriter writer = new FileWriter("CardGame\\View\\Logs\\Partidas2v2\\Log2v2.txt", true); // Abre o arquivo para escrita
           
            // Escreve os dados no arquivo
            writer.write("O jogador " + vencedor.getNome() + ", CPF:" + vencedor.getCpf() + "Venceu a partida." +"\n");
